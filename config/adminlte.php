...
return [
    ...
    */
    ...
    'logo' => '<b>INET</b> System',
    'logo_img' => 'vendor/adminlte/dist/img/AdminLTELogo.png',
    'logo_img_class' => 'brand-image img-circle elevation-3',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'INET Logo',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can add a custom CSS for your admin panel.
    |
    | For detailed instructions you can look the custom css section here:
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can add a custom JS for your admin panel.
    |
    | For detailed instructions you can look the custom js section here:
    | https://github.com/jeroennoten/Laravel-AdminLTE/wiki/Other-Configuration
    |
    */
    ...
    */
    ...
    'menu' => [
        ...
        // SuperAdmin Menu
        [
            'header' => 'SUPERADMIN MENU',
            'can'    => 'superadmin',
        ],
        [
            'text' => 'Dashboard Superadmin',
        ...
        [
            ...
            'url'  => 'superadmin/financial/report',
        ...
        [
            ...
            'url'  => 'technician/customers',
            'icon' => 'fas fa-fw fa-users',
            'can'  => 'technician',
        ],
        [
            'text' => 'Laporan Keuangan',
            'url'  => 'technician/financial/report',
            'icon' => 'fas fa-fw fa-chart-line',
            'can'  => 'technician',
        ],
    ],
